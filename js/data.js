...
const TOPICS = [
  ...
  /* ---------------------------------------------------- 5 */
  {
    ...
    explicacion: [
      `Entrenar un modelo grande desde cero exige millones de ejemplos y semanas de cómputo. Casi nadie tiene eso. La salida es no empezar de cero.`,
      `El proceso tiene <strong>dos etapas muy desiguales</strong>. La primera, el <strong>preentrenamiento</strong>, es la cara: un modelo aprende sobre datos masivos y generales. La segunda, el <strong>fine-tuning</strong>, es barata: se continúa ese entrenamiento con unos pocos miles de ejemplos de tu tarea concreta.`,
      `Lo importante es que la etapa cara <strong>se paga una sola vez</strong>. Un mismo modelo base puede dar origen a cientos de modelos especializados distintos.`,
      `¿Por qué funciona? Porque las primeras capas de una red aprenden lo general —bordes y texturas en imágenes, sintaxis en texto— y solo las últimas aprenden la tarea concreta. <strong>Un borde sigue siendo un borde en una radiografía.</strong> Eso es justamente lo que se transfiere.`,
      `Durante el ajuste se usa una <strong>tasa de aprendizaje baja</strong>. Si se ajusta con demasiada fuerza, el modelo sobrescribe lo que ya sabía: es el <strong>olvido catastrófico</strong>.`,
      `Ajustar todos los parámetros de un modelo de miles de millones sigue siendo carísimo. Por eso existe <strong>LoRA</strong> (Hu et al., 2021): congela los pesos originales y entrena solo unas matrices pequeñas añadidas. El artículo reporta <strong>10.000 veces menos parámetros entrenables</strong> y <strong>3 veces menos memoria</strong>, con calidad igual o mejor.`,
    ],
    confusion: {
      titulo: "La confusión más frecuente",
      a: "Transfer learning",
      aDesc: "Es la <b>estrategia</b>: reutilizar conocimiento ya aprendido. Incluye usar el modelo congelado como simple extractor de características, sin tocarle un solo peso.",
      b: "Fine-tuning",
      bDesc: "Es una <b>técnica concreta</b> dentro de esa estrategia: seguir entrenando el modelo con datos de la tarea nueva. Sí modifica los pesos.",
      clave: "Todo fine-tuning es transfer learning, pero no todo transfer learning es fine-tuning.",
    },
    pasos: [
